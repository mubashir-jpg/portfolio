...
export const Home = () => {
  ...
  Hi, I am a React Developer
            ...
            <div className="flex justify-center space-x-0.5">
                <a href="3Project" className="bg-blue-500  text-white git push origin main
 px-6 rounded font-meadium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow[0_0_15px_rbga(59, 130, 246, 0.4)]">Views Project</a>

                <a href="3Contact" className="border border-blue-500/50 text-blue-500  px-6 rounded font-medim transition-all duration-200 hover:-translate-y-0.5 hover:shadow[0_0_15px_rbga(59, 130, 246, 0.4)] hover:bg-blue-500/10">Contact Me</a>
